...
Комментарии и поля `System.Description`,
`Microsoft.VSTS.Common.AcceptanceCriteria`, `Microsoft.VSTS.TCM.ReproSteps`
являются HTML-полями в TFS. Передавайте в них Markdown с реальными переводами
строк: CLI автоматически преобразует заголовки, абзацы, списки, ссылки,
выделение и встроенный код в HTML. Готовый HTML также поддерживается и не
